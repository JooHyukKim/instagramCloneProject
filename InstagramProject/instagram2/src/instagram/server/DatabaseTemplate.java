...
public interface DatabaseTemplate {
	...
	boolean updateUser(User user) throws SQLException, RecordNotFoundException;	//회원정보 변경
	boolean deleteUser(String userId, String password) throws SQLException, RecordNotFoundException; //회원탈퇴
	boolean authenticateUser(String userId, String password) throws Exception, SQLException; //사용자로그인 + 관리자여부 Boolean값 리턴
	...
	boolean addComment(String userId, String postId, String comment) throws Exception, SQLException, RecordNotFoundException; //사용자가 게시물에 댓글 작성
	boolean updateComment(String userId, int commentid, String postId, String comment) throws Exception, SQLException, RecordNotFoundException; //사용자가 자신의 댓글 수정
	boolean deleteComment(String userId, String postId, int commentId) throws Exception, SQLException; //사용자가 자신의 댓글 삭제
	...
	boolean likeComment(String userId, int commentId) throws Exception, SQLException;
	
	boolean addPost(String userId, Post post)throws Exception, SQLException; //사용자가 게시물 작성
	...
	boolean updatePost(String userId, Post post) throws Exception, SQLException; //사용자가 자신의 게시물 수정
	boolean deletePost(String userId, Post post) throws Exception, SQLException; //사용자가 특정 게시물 삭제
	boolean likePost(String userId, String postId) throws Exception, SQLException;
